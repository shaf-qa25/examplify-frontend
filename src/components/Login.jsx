...
const schemas = {
  SignUp: z.object({
    ...
    studentno: z.string().min(4, 'Student No must at least 4 digits ').max(8, 'Student No sould not exceed 8 digits').regex(/^\d+$/, 'Student No must be numeric'),
                    ...
                    <div className='flex flex-col gap-y-6 '>
                      ...
                      <div className="justify-items-start w-full">
                        ...
                        <input
                          ...
                          type="number"
                          {...register('studentno')}
                          className="no-spinner block w-full min-w-xl text-black border-b border-blue-500 focus:border-blue-500 focus:outline-none bg-transparent placeholder-[rgba(0,0,0,0.7)]"
                        />
